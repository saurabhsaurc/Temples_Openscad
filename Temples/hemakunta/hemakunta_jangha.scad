...
jangha_height_array = [ 15, 10, 15, 10, 15, 20];
jangha_size_array = [ 1, 0.97, 1, 0.97, 1, 1.04 ];
jangha_diagonal_array = [ 0, 0, 0, 0, 0, 1]; //1st element must be 0

jangha(3.8*temple_profile, 3.8*temple_mid_profile, 3.8*temple_center_offset, jangha_height_array, jangha_size_array,jangha_diagonal_array );
